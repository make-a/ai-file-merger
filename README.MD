...
| 悬浮球（常态）                                                   | 拖拽时展开                                                                           | 弹窗编辑界面                                                                                    |
| ---------------------------------------------------------------- | ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------- |
| ![Ball](https://via.placeholder.com/150/333/fff?text=📂+AI+Drop) | ![Active](https://via.placeholder.com/600x180/222/fff?text=📁+Drop+Files+or+Folders) | ![Modal](https://via.placeholder.com/900x500/1f1f1f/fff?text=File+List+%2B+Preview+%2B+Actions) |
